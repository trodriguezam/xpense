...
struct TutorialView: View {
    ...
    private let pasos: [Paso] = [
        ...
        .init(icono: "creditcard.fill",
              titulo: String(localized: "5 · Conecta la Tarjeta (opcional)"),
              detalle: String(localized: "Si quieres llevar el gasto por tarjeta, repite en el campo Tarjeta: tócalo, elige Entrada del atajo y luego el subcampo Tarjeta.\n\nFinalmente toca Listo para guardar la automatización.")),
